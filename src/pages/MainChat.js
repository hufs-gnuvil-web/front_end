    ...
    <MainChatStyle>
      ...
      <div className="mainchat-address">
        ...
        <div className="mainchat-address-sub">
          <div className="mainchat-address-sub-left"></div>
          <div className="mainchat-address-sub-right">
            <div>
              {sessionStorage.name} 님, {address.address} 근처의 이웃들과
              <br />
              배달비 쉐어를 시작해보세요!
            </div>
        ...
        {!currentRoom ? (
          <CreateChatStyled>
            ...
            <div className="cc-inputwrapper">
              ...
              <button className="cc-savebtn" onClick={handleCreateRoom}>
                저장
              </button>
            </div>
          </CreateChatStyled>
          ...
          <PopupChatStyled>
            ...
            <div className="pc-roomname">{currentRoom.roomName}</div>
